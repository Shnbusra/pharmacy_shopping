...
<?php
	...
	$duzenlesorgusql="Select * from hakkimda2";
	...
	if($_POST){
		...
		$hakkimda2_aciklama=$_POST["hakkimda2_aciklama"];
				...
				if($uzanti1=="png" || $uzanti1=="PNG" || $uzanti1=="jpg" || $uzanti1=="JPG" || $uzanti1=="jpeg" ||$uzanti1=="JPEG" )
				{
					...
					$yeniadresi=$duzenlesatir["hakkimda2_gorsel"];
				}
				
		$guncellesql="UPDATE hakkimda2 SET hakkimda2_baslik='$hakkimda2_baslik', hakkimda2_aciklama='$hakkimda2_aciklama', 
              ...
              <form method="POST" enctype="multipart/form-data">
                <div class="card-body">
				  ...
				  <div class="form-group">
                    ...
                    <input type="text" class="form-control" name="hakkimda2_baslik" maxlength="50" value="<?php echo $duzenlesatir["hakkimda2_baslik"]; ?>" required>
                  </div>
				  <div class="form-group">
                    <label class="col-form-label" for="inputSuccess">Neden Biz Açıklama</label>
                    <input type="text" class="form-control" name="hakkimda2_aciklama" maxlength="500" value="<?php echo $duzenlesatir["hakkimda2_aciklama"]; ?>" required>
                  </div>
                  <div class="form-group">
